...
// Empty returns true if GroupVersionResource is zero value.
...
// Empty return true if group and kind is zero value.
...
// Empty returns if group, version, and kind are empty.
...
func ParseGroupVersion(gv string) (GroupVersion, error) {
	...
	// TODO once we've cleared the last user as strings, this special case should be removed.
	if len(gv) == 0 || (gv == "/") {
