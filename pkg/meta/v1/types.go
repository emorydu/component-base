...
type ObjectMeta struct {
	...
	// CreatedAt is a timestamp representing the server time when this object wat
	// created. It is not guaranteed to be set in happens-before order across separated operations.
	// Clients may not set this value. It is represented in RFC3339 from and is in UTC.
	//
	// Populated by the system.
	// Read-Only.
	// Null for lists.
...
// AfterFind run after find to unmarshal a `extendShadow` string into metav1.Extend struct.
...
type ExportOptions struct {
	...
	// Should this export be exact. Exact export maintains cluster-specific fields like `Namespace`.
	// Deprecated. Planned for removal in 1.18.
